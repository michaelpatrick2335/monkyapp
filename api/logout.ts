...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const reset = await updateUser(pool, userRow.id, { name: "Seeker", tier: "newbie", level: 1, bananas: 0, totalSessions: 0, totalSecondsMediated: 0, streakDays: 0, lastSessionDate: null, isPremium: false, freeSessionsUsed: 0 });
